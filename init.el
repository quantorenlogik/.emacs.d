...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (deft centaur-tabs solaire-mode fancy-battery doom-modeline all-the-icons htmlize org-download dmenu powerline company files sudo-edit switch-window avy doom-themes which-key use-package)))
